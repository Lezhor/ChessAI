...
public class AI_MiniMax3 extends Player {
     ...
     */
    private static final int PIECES_LEFT_PAWN_POS_MATTER = 12;
     ...
     */
    public AI_MiniMax3(int player) {
        super(player, "AI MiniMax 3");
        SEARCH_DEPTH = 4;
    }
     ...
     */
    private static float getScoreModifier_PawnPos(int[] board) {
